            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 col-sm-12">
                    <div class="photodiary-page">
                        ...
                        <?php
                        global $post; 
                        $args = array('numberposts' => 1,'category' => 16); //
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1 col-sm-12">
                ...
                <?php
                global $post;
                $args = array('numberposts' => 2, 'category' => 17);
                foreach( $myposts as $post ){ setup_postdata($post);
                    ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1 col-sm-12">
                ...
                <?php
                global $post;
                $args = array('numberposts' => 2, 'offset' => 1, 'category' => 16);
                $myposts = get_posts( $args );
                foreach( $myposts as $post ){ setup_postdata($post);
                    ?>
                    <div class="col-md-6 col-sm-6">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1 col-sm-12">
                ...
                <?php
                global $post;
                $args = array('numberposts' => 2, 'offset' => 2, 'category' => 17); 
                $myposts = get_posts( $args );
                foreach( $myposts as $post ){ setup_postdata($post);
                    ?>
                    <div class="col-md-6 col-sm-6">
